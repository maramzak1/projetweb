<?php    
include 'C:\xampp\htdocs\projetweb\view\backoffice\assets\sneat-bootstrap-html-admin-template-free\sneat-bootstrap-html-admin-template-free\html\commentaireC.php';
...
<table border="1" align="center" width="70%">
    ...
    ?>
        ...
        <tr>
            ...
            <td>
                <!-- Correction du nom du paramètre dans le lien -->
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item active">
                  <a href="ui-alerts.html" class="menu-link">
                    <div data-i18n="Alerts">comments</div>
                  </a>
                </li>
                <li class="menu-item">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">UI elements /</span>comments</h4>
              <div class="row mb-4">
