        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                if (isset($_POST['comment_id'])) {
                    ...
                    if ($commentaire) { // Check if $region is not null
                ?>
                        <form action="" method="POST">
                          <input type="hidden" name="comment_id" value="<?php echo $commentaire['comment_id']; ?>">
                          <input type="hidden" name="post" value="<?php echo $commentaire['post']; ?>">

                          <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="comment_text">comment_text</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-name" name="comment_text" value="<?php echo $commentaire['comment_text']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="author">author</label>
                                  <div class="col-sm-10">
                                  <textarea class="form-control" id="basic-default-author" name="author" rows="4"><?php echo $commentaire['author']; ?></textarea>
                                    </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-created_at">created_at</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="basic-default-created_at" name="created_at" value="<?php echo $commentaire['created_at']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <a href="listecommentaire.php" class="btn btn-secondary">Cancel</a>
                            </div>
                            <div class="col-sm-10">
                        ...
                        if (isset($_POST['update_commentaire'])) {
                            ...
                            $updatedcommentaire = new commentaire($comment_id, $comment_text, $author, $created_at,$post);


                            $commentaireC->updatecommentaire($updatedcommentaire,$comment_id);
                            header('Location:listecommentaire.php');
                        }
                        ?>
                ...
                <?php
                        ...
                        echo "post not found"; // Handle the case where the region is not found
                    }
                }
                ?>
            </div>
