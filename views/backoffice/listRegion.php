...
<html
  ...
  <!-- Layout wrapper ORGANISATION MADHHER -->
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-name" name="nom" placeholder="Saisissez le nom d'une région de la Tunisie." />
                            </div>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <div class="card">
                <h5 class="card-header">Liste des Régions</h5>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      <?php foreach ($tab as $region) { ?>
                        <tr>
                        
                          
                          <td><span class="badge bg-label-primary me-1"><?= $region['id_region']; ?></span></td>
                          <td>
                            <i class="bx bxl-angular bx-sm text-danger me-3"></i>
                            <span class="fw-medium"><?= $region['nom']; ?></span>
                          </td>
                          <td>
                            <i class="bx bxl-angular bx-sm text-danger me-3"></i>
                          ...
                          <td>
                            ...
                            <form method="POST" action="updateRegion.php">
                                ...
                                <input type="hidden" value="<?= $region['id_region']; ?>" name="id_region">
                            </form>
                        </td>
