    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Modifiez region</h5>
                ...
                ?>
                        ...
                        <input type="hidden" name="id_region" value="<?php echo $region['id_region']; ?>">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-name" name="nom" value="<?php echo $region['nom']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-image" name="image" value="<?php echo $region['image']; ?>" />
                                </div>
                            </div>
