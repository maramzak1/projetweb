...
include 'C:\xampp\htdocs\projet_musique - Copie\views\frontOffice\updateUtilisateur.php';
include 'C:\xampp\htdocs\projet_musique - Copie\views\frontOffice\deleteUtilisateur.php';
		...
		<div class="wrapper" id="home">
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="views/sneat-bootstrap-html-admin-template-free/sneat-bootstrap-html-admin-template-free/html/auth-login-basic.html">Se connecter</a></li>
							</ul>
						</div><!-- /.navbar-collapse -->
					</div><!-- /.container-fluid -->
				</nav>
			...
			<div class="news-letter">
				<div class="container">
					...
					<div class="news-content ">
						...
						<!-- paragraph -->
						<p><strong>gere le compte</strong></p>
						<!-- subscribe form -->
						<form>
			...
			<div class="contact pad" id="contact">
				<div class="container">
					...
					<a href="deleteUtilisateur.php?id=<?php echo $utilisateur['idUtilisateur ']; ?>">Delete</a>

				</div>
			</div>

			<h2>
				<a href="views\addUtilisateur.php">Add user</a>
			</h2>
			<!-- contact end -->
