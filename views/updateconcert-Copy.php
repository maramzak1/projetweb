                ...
                ?>
                        <form action="" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-name" name="date" value="<?php echo $concert['date']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-name" name="etat" value="<?php echo $concert['etat']; ?>" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-image">Image</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-image" name="image" value="<?php echo $concert['image']; ?>" />
                                </div>
                            </div>
