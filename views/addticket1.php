...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../Assets/backoffice/assets/img/favicon/logo.png" />
...
<div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <!-- Forms & Tables -->
           <li class="menu-header small text-uppercase"><span class="menu-header-text">Gestion concert</span></li>
          ...
          <ul class="menu-inner py-1">
             ...
             <li class="menu-item">
                <a href="AddRegion.php" class="menu-link">
                  ...
                  <div data-i18n="Tables">Ajout concert</div>
                </a>
             </li>
             ...
             <li class="menu-item">
                 <a href="listRegion.php" class="menu-link">
                  ...
                  <div data-i18n="Datatables">Liste des concerts</div>
                 </a>
            </li>
            ...
            <li class="menu-item  active">
                 <a href="AddFolklore.php" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-grid"></i>
                  <div data-i18n="Datatables">Ajout ticket</div>
                 </a>
            </li>
            ...
            <li class="menu-item  ">
                 <a href="listFolklore.php" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-grid"></i>
                  <div data-i18n="Datatables">Liste Des tickets</div>
                 </a>
            </li>
