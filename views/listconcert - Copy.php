        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0"> Ajouter concerts</h5>
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-date" name="date" placeholder="date du concerts" oninput="validateDate()"/>
                            </div>
                        </div>
                        <!-- concerts lieu -->
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-etat" name="etat" placeholder="etat du concerts" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="image" id="basic-default-pic" placeholder="Insérez une image du concerts" />
                            </div>
                        </div>
...
function validateForm() {
    ...
    var etatInput = document.getElementById('basic-default-etat');
    ...
    function validateDate() {
        ...
        if (!dateRegex.test(date)) {
            alert('Veuillez saisir une date valide au format dd-mm-yyyy.');
            dateInput.value = '';
        }
    }
