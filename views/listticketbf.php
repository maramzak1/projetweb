...
<ul class="menu-inner py-1">
    <li class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'listconcert - Copy.php' ? 'active' : ''; ?>">
  ...
  <ul class="menu-inner py-1">
    <li class="menu-item <?php echo basename($_SERVER['PHP_SELF']) == 'listticketbf.php' ? 'active' : ''; ?>">
        <a href="listticketbf.php" class="menu-link">
            <i class="menu-icon tf-icons bx bx-table"></i>
            <div data-i18n="Tables">Gestion des tickets</div>
        </a>
    </li>
</ul>
