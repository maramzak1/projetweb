...
class reclamationC
{
    ...
    function listReclamationsUser($idUtilisateur)
    {
      $sql = "SELECT * FROM reclamation WHERE idUtilisateur = :idUtilisateur";
      $db = config::getConnexion();
      try {
        $stmt = $db->prepare($sql);
    ...
    public function addReclamation($titre, $description, $etat, $idUtilisateur)
{
    // Connexion à la base de données
    $pdo = config::getConnexion();

    // Préparation de la requête
    $sql = "INSERT INTO reclamation (titre, description, etat, idUtilisateur) VALUES (:titre, :description, :etat, :idUtilisateur)";
