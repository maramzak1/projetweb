...
<html
  ...
  <head>
    ...
    <title>Table  des réclamations</title>
    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <a href="solve.php"><button type="button" class="btn btn-outline-primary">back to list</button></a>
                    <h5 class="mb-0">Modifier une reponse</h5>
                    <small class="text-muted float-end">Mise à jour des réponses</small>
                </div>
            ...
            <div class="card-body">
                ...
                if (isset($_POST['idReponse'])) {
                    ...
                    if ($reponse) { // Check if $region is not null
                ?>
                        <form action="" method="POST">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="idReponse">ID</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-id" name="idReponse" value="<?php echo $reponse['idReponse']; ?>" readonly />
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="idReclamation">IdReclamation</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-idReclamation" name="idReclamation" value="<?php echo $reponse['idReclamation']; ?>" />
                                </div>
                            </div>

                            <div class="row justify-content-end">
                                <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary" name="update_reponse" value="update_reponse">Update</button>
                        ...
                        if (isset($_POST['update_reponse']) && $_POST['update_reponse'] === 'update_reponse') {
                            
                            $idReponse = isset($_POST['idReponse']) ? $_POST['idReponse'] : '';
                            $reponse = isset($_POST['reponse']) ? $_POST['reponse'] : '';
                          
                            $idReclamation= isset($_POST['idReclamation']) ? $_POST['idReclamation'] : '';

                            
                            $updatedReponse = new reponse($idReponse, $reponse, time(),$idReclamation);

                            
                            $reponseC->updateReponse($updatedReponse, $idReponse);
                ...
                <?php
                        ...
                        echo "reponse not found"; // Handle the case where the region is not found
                    }
                }
                ?>
            </div>
