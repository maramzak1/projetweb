            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="" method="POST" >
                        ...
                        <div class="row mb-3">
    <label class="col-sm-2 col-form-label" for="idReclamation">ID de Réclamation</label>
    <div class="col-sm-10">
        <select class="form-control" name="idReclamation" id="idReclamation">
            ...
            try {
                ...
                $requete = $pdo->prepare("SELECT idReclamation FROM reclamation");
                $requete->execute();

                // Vérifiez s'il y a des résultats
                if ($requete->rowCount() > 0) {
                    // Affichez chaque ID comme une option dans la liste déroulante
                    while ($row = $requete->fetch(PDO::FETCH_ASSOC)) {
                        echo "<option value='" . $row['idReclamation'] . "'>" . $row['idReclamation'] . "</option>";
                    }
                } else {
