...
<body>
    ...
    <div class="container">
        ...
        <div class="default-heading">
            ...
            <p style="font-size: 20px; font-weight: bold; color: #404040; text-align: right; margin-left: 65%; white-space: nowrap;">Si vous avez une réclamation, n'hésitez pas à nous contacter !</p>
        </div>
    ...
    <div class="col-md-4 col-sm-4">
        ...
        <div class="contact-item" style="margin-right: 40px; margin-bottom: 20px;">
            ...
            <!-- contact details  -->
            <span class="contact-details" style="color: #ffffff; font-size: 20px;">ElGhazela</span>
        </div>
    </div>
    <div class="col-md-4 col-sm-4">
        <!-- contact item -->
        <div class="contact-item" style="margin-left: 80px; margin-right: 40px; margin-bottom: 20px;">
            <!-- big icon -->
            <i class="fa fa-wifi"></i>
            <!-- contact details  -->
            <span class="contact-details" style="color: #ffffff; font-size: 18px;">tunisika@melodi.com</span>
        </div>
    </div>
    <div class="col-md-4 col-sm-4">
        <!-- contact item -->
        <div class="contact-item" style="margin-left: 200px; margin-bottom: 100px;">
            ...
            <!-- contact details  -->
            <span class="contact-details" style="color: #ffffff; font-size: 20px;">5555555555</span>
        </div>
    </div>
</div>
