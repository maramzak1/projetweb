...
if(isset($_SESSION['e']) && !empty($_SESSION['e'])) {
	...
	$tab = $c->listReponseUser($idUtilisateur);
?>
<html lang="fr">
<head>
    <meta charset="UTF-8" />
    ...
    <!-- Styles -->
        ...
        <style>
			...
			background-image: url('../../assets/frontoffice/img/reclamation/backg6.jpeg');
...
function getComplaintDetails($pdo, $idReclamation) {
    ...
    ?>
      ...
      <a href="listReclamations.php" class="btn btn-warning" style="margin-left: 150px;">Afficher Liste Des Reclamations</a>
      <a href="Region.php" class="btn btn-danger" style="margin-left: 150px;">Retour a la page acceuil</a>
    </div>
  </div>
</div>
