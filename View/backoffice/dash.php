...
$selectedMonth = isset($_GET['month']) ? $_GET['month'] : (!empty($distinctMonths) ? $distinctMonths[0]['distinct_month'] : null);

// Utilize $selectedMonth as needed in your code
                    ...
                    <div class="d-flex align-items-end row">
                      ...
                      <button><a href="index.php" class="btn btn-secondary">Back to list</a></button>
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                           Voici   <span class="fw-medium"></span>Votre Dashboard.
                          </p>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-medium d-block mb-1">Overviews</span>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h3 class="card-header m-0 me-2 pb-3">Overview Des Réclamations</h3>
                        <div class="container">
                        <style>
                          .separator {
                            width: 90%;
...
<script>
    ...
    box-shadow: 0 0.125rem 0.25rem 0 #fff;
}</style>
