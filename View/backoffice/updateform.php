...
if (
    isset($_POST["reponse"])&& isset($_POST["idReclamation"])
   
) {
    if (
        !empty($_POST['reponse']) && isset($_POST["idReclamation"])
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                    <button><a href="solve.php">Back to list</a></button>
                    <hr>
                    ...
                    ?>
                      <form  action="" method="POST">
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="idReponse" >id de reponse:</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="idReponse" name="idReponse" value="<?php echo $_POST['idReponse'] ?>" readonly />
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-reponse" name="reponse" placeholder="Saisissez la reponse" />
                            </div>
                        </div>
                          </div>
