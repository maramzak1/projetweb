...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['nom']) && !empty($_POST['histoire']) && !empty($_POST['chanson'])&& !empty($_POST['region'])&& !empty($_POST['banner'])&& !empty($_POST['artiste'])   ) {
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php foreach ($tab as $folklore) { ?>
                        <tr>
                          ...
                          <td>
                            <i class="bx bxl-angular bx-sm text-danger me-3"></i>
                            <span class="fw-medium"><?= $folklore['artiste']; ?></span>
                          </td>
                          <td>
