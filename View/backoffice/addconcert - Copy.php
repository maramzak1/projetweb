            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="" method="POST">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="basic-default-name-date" name="date" placeholder="Date du concert" />
                        </div>
                        </div>
                        ...
                        <!-- concert Image -->
                                ...
                                <div class="col-sm-10">
                                 ...
                                 <div class="row mb-3">
                           <label class="col-sm-2 col-form-label" for="utilisateur">Artiste</label>
                           <div class="col-sm-10">
                                 <select name="utilisateur" id="utilisateur">
                                  <?php
                                  foreach ($tabb as $utilisateur) {
                                    if ($utilisateur['configuration']==2){
                                  echo '<option value="' . $utilisateur['idUtilisateur'] . '">' . $utilisateur['nom'] .'</option>';
                                   }}
                                  ?>
                                  </select>
                           </div>
...
function validateForm() {
    ...
    if (etat === 'termine') {
        alert('Vous ne pouvez pas ajouter un concert dont létat est "terminé".');
        return false;
    }
