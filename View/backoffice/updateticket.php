...
include_once '../Controller/concertC.php';
 ...
 <body>
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Modifiez ticket </h5>
                ...
                ?>
                        ...
                        <!-- date concerts -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="basic-default-date" name="date" placeholder="date du concerts" value="<?php echo $ticket['date']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="basic-default-prix" name="prix" placeholder="prix du ticket" value="<?php echo $ticket['prix']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="basic-default-datelimite" name="date_limite" placeholder="datelimite du ticket" value="<?php echo $ticket['date_limite']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="basic-default-quantite" name="quantite" placeholder="combien du ticket voulez vous" value="<?php echo $ticket['quantite']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="basic-default-heure" name="heure" placeholder="heure du concert" value="<?php echo $ticket['heure']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-lieu" name="lieu" placeholder="lieu du concerts" value="<?php echo $ticket['lieu']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="basic-default-concert" name="concert" placeholder="concerts" value="<?php echo $ticket['concert']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="image" id="basic-default-pic" placeholder="Insérez une image " value="<?php echo $ticket['image']; ?>" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="quantite_ticket">quantite_ticket</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="basic-default-quantite_ticket" name="quantite_ticket" placeholder="nombre de place disponible" value="<?php echo $ticket['quantite_ticket']; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary" name="update_ticket" value="update_ticket">Update</button>
                        ...
                        if (isset($_POST['update_ticket'])) {
                            ...
                            $date = isset($_POST["date"]) ? $_POST['date']: '';
                             ...
                             $quantite_ticket=isset($_POST["quantite_ticket"])?$_POST["quantite_ticket"]: ''; 
                            

                            // Create a concert object
                            $updatedticket = new ticket($id_ticket, $date,$prix,$date_limite,$quantite,$heure,$lieu,$concert,$image,$quantite_ticket);
  ...
  document.addEventListener('DOMContentLoaded', function () {
    function validateForm() {
        ...
        var dateLimiteInput = document.getElementById('basic-default-datelimite');

        
        function isEmpty(value) {
          return value.trim() === ''; // This trims the value before checking if it's empty
          }

      if (isEmpty(dateInput.value) || isEmpty(prixInput.value) || isEmpty(quantiteInput.value) || isEmpty(lieuInput.value) || isEmpty(imageInput.value) || isEmpty(dateLimiteInput.value)) {
