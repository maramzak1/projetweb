...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['nom']) && !empty($_POST['histoire']) && !empty($_POST['chanson'])&& !empty($_POST['banner'])&& !empty($_POST['region'])&& !empty($_POST['artiste'])  ) {
...
<a href="javascript:void(0);" class="menu-link menu-toggle">
                    ...
                    <form class="form-horizontal" action="" method="POST">
                        ...
                        <div class="row mb-3">
                           ...
                           <div class="col-sm-10">
                                 <select name="region" id="region">
                                  ...
                                  echo '<option value="' . $region['id_region'] . '">' . $region['nom'] . '</option>';
                                   }
                                  ?>
                                  </select>
                           </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" name="chanson" id="basic-default-chanson"   directory="../../Assets/frontoffice/img/video" />
                            </div>
                        </div>
                       ...
                       <label class="col-sm-2 col-form-label" for="banner">Banner</label>
                           <div class="col-sm-10">
                                <input type="file" class="form-control" name="banner" id="basic-default-banner"  directory="../../Assets/frontoffice/img/banner" />
                                </div>
                      </div>
                      ...
                      <div class="row mb-3">
                           ...
                           <div class="col-sm-10">
                                 <select name="artiste" id="artiste">
                                  ...
                                  echo '<option value="' . $artiste['idUtilisateur'] . '">' . $artiste['nom'] .'</option>';
                                   }}
                                  ?>
                                  </select>
                           </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function validateForm() {
            ...
            if (nom.length < 5 || nom.length > 60 || /\d/.test(nom) || !isFirstLetterUpperCase(nom)) {
                displayError(nomInput, 'Le nom doit commencer par une lettre en majuscule, ne doit pas contenir de chiffres, et doit avoir une longueur entre 5 et 60 caractères.');
                return false;
            }

            // Validation de  description
            var histoire = histoireInput.value;
            if (histoire.length < 10  || !isFirstLetterUpperCase(histoire) || !histoire.endsWith('.')) {
                displayError(histoireInput, 'L histoire doit commencer par une majuscule, se terminer par un point');
                return false;
            }
